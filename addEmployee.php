...
<form action = "" method = "POST">
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text2" name="firstName" type="text" class="form-control" value="<?=$row["firstName"] ?>">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="radio" id="radio_0" type="radio" class="custom-control-input" value="2" <?= ($row["cityId"]== 2)? "checked" : "" ?> >
        <label for="radio_0" class="custom-control-label">Taipei</label>
      </div>
      <div class="custom-control custom-radio custom-control-inline">
        <input name="radio" id="radio_1" type="radio" class="custom-control-input" value="4" <?= ($row["cityId"]== 4)? "checked" : "" ?> > 
        <label for="radio_1" class="custom-control-label">Taichung</label>
      </div>
      <div class="custom-control custom-radio custom-control-inline">
        <input name="radio" id="radio_2" type="radio" class="custom-control-input" value="6" <?= ($row["cityId"]== 6)? "checked" : "" ?> > 
  ...
  <div class="form-group row">
    <div class="offset-4 col-8">
      ...
      <button name="okButton" type="submit" class="btn btn-primary" value="OK">Submit</button>
      <button name="cancelButton" type="submit" class="btn btn-primary" value="cancel">cancel</button>
...
<!-- <form>
  <div class="form-group row">
    <label for="text2" class="col-4 col-form-label">First Name</label> 
    <div class="col-8">
      <input id="text2" name="firstName" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label for="text1" class="col-4 col-form-label">Last Name</label> 
  ...
  <div class="form-group row">
    <div class="offset-4 col-8">
    <form action = "" method = "POST">
      <button formmethod="post" name="okButton"  type="submit" class="btn btn-primary" value="OK">Submit</button>
    </form>
    </div>
  </div>
</form> -->
